        ...
        while True:
            ...
            try:
                ...
                async with aiofiles.open(state_path, "w") as file:
                    ...
                    state_json = json.dumps(state, cls=DateTimeEncoder)
                    await file.write(state_json)

                # Save chat history to file.
                async with aiofiles.open(history_path, "w") as file:
                    history_json = json.dumps(history, cls=DateTimeEncoder)
                    await file.write(history_json)
